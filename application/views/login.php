...
<head>
  ...
  <title>Login Page - SIM Inventaris</title>
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form class="form-horizontal form-simple" action="<?php echo site_url('login/action');?>" method="POST">
                      ...
                      <button name="login" type="submit" class="btn btn-primary btn-lg btn-block"><i class="ft-unlock"></i> Login</button>
                    </form>
                  </div>
                </div>
                <div class="card-footer">
                  <div class="">
                    <p class="float-sm-right text-center m-0">Belum Terdaftar? <a href="#" class="card-link">Hubungi Admin</a></p>
                  </div>
                </div>
              </div>
            </div>
